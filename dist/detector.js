 ...
 *          wishes to assign
 */
Detector.prototype.detect = function (detectOpts, deviceData) {
    ...
    s.bind(detectOpts.bindPort, detectOpts.bindAddress, function () {
        ...
        _search = function search() {
            ...
            s.discover('SRCH', null, deviceData);
            self.searchTimer = setTimeout(_search, 1000);
        };
 ...
 */
Detector.findWhen = function (filterFn, detectOpts, deviceData, callback) {
 ...
 */
Detector.findFirst = function (filterFn, detectOpts, deviceData, callback) {
    return Detector.findWhen(filterFn, detectOpts, deviceData, function (err, device, rinfo) {
...
Detector.findAny = function (detectOpts, deviceData, callback) {
    return Detector.findFirst(function () {
        return true;
    }, detectOpts, deviceData, callback);
};

Detector.find = function (address, detectOpts, deviceData, callback) {
