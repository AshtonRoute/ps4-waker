...
Ps4Socket.prototype.connect = function (host, port) {
    ...
    udp.bind(function () {
        ...
        //  TCP connection
        udp.discover("WAKEUP", creds, device).then(function () {
...
Ps4Socket.prototype.close = function () {
    ...
    this.client.end(this.packets.newByePacket().encrypted().buf);
...
Ps4Socket.prototype.login = function (pinCodeOrConfig, callback) {
    ...
    if (callback) {
        ...
        var self = this;
        var loginTimeout;
        var onLoginResult = function onLoginResult(result) {
...
var KnownPackets = {
    ...
    0x6f636370: function _(packet) {
        ...
        if (this.config.autoLogin) {
            ...
            var self = this;
            this.login(this.config, function (result) {
